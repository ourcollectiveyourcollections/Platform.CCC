...
This package is upload-ready for `ourcollectiveyourcollections/Platform.CCC`.

It was prepared after the live GitHub connector could read the repo but could not write to it due to integration write-scope restrictions.
